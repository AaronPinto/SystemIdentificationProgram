...
public class ADXRS453Gyro {
	...
	private static final byte STATUS_MASK = (byte) 0x0C;
	...
	private static final byte ADXRS453_REG_TEM = (byte) 0x02;
	private static final byte ADXRS453_REG_PID = (byte) 0x0C;
	//angle integration
	...
	private static String getBinaryFromByte(byte[] bytes) {
		StringBuilder temp = new StringBuilder();
		for(byte b : bytes)
			temp.append(Integer.toBinaryString(b & 255 | 256).substring(1)).append(" ");
	...
	private short getRegisterValue(byte registerAddress) {
	...
	private void update() {
		...
		if(calibrate) {
			...
			double CALIBRATION_PERIOD = 10.0;
